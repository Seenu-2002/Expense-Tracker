...
object ChartDefaults {
    val dynamicColors = listOf(
        ...
        Color(0xFFFFF59D), // Soft Cream
        Color(0xFFFFA726), // Soft Orange
        Color(0xFFB39DDB), // Pale Lavender
        Color(0xFF7986CB), // Indigo Tint
        Color(0xFF4FC3F7), // Bright Sky
        Color(0xFF64FFDA), // Light Mint
        Color(0xFFDCE775), // Pastel Green
        Color(0xFFFFD54F), // Sunflower Yellow
        Color(0xFFFF7043), // Soft Coral
        Color(0xFFBA68C8), // Light Lilac
